...
export default async function DisclaimerPage() {
  return (
    <div className="px-4 pt-6 pb-4">
      <h1 className="text-xl font-bold text-[#1A1A1A]">免责声明</h1>

      <div className="mt-4 space-y-4 text-sm text-[#374151] leading-relaxed">
        <section>
          <h2 className="font-semibold text-[#1A1A1A]">1. 性质说明</h2>
          <p className="mt-1">
        ...
        <section>
          <h2 className="font-semibold text-[#1A1A1A]">2. 不替代专业咨询</h2>
          <p className="mt-1">
        ...
        <section>
          <h2 className="font-semibold text-[#1A1A1A]">3. 数据准确性</h2>
          <p className="mt-1">
        ...
        <section>
          <h2 className="font-semibold text-[#1A1A1A]">4. 计算工具</h2>
          <p className="mt-1">
        ...
        <section>
          <h2 className="font-semibold text-[#1A1A1A]">5. AI 助手</h2>
          <p className="mt-1">
        ...
        <section>
          <h2 className="font-semibold text-[#1A1A1A]">6. 责任限制</h2>
          <p className="mt-1">
